...
export default function RegisterPage() {
  ...
  const validateField = (name: string, value: string): string => {
    switch (name) {
      case 'name':
        return !PATTERNS.name.test(value) ? ERROR_MESSAGES.name : '';
      case 'email':
        return !PATTERNS.email.test(value) ? ERROR_MESSAGES.email : '';
      case 'phone':
        return !PATTERNS.phone.test(value) ? ERROR_MESSAGES.phone : '';
      case 'password':
        return !PATTERNS.password.test(value) ? ERROR_MESSAGES.password : '';
      case 'confirmPassword':
        return value !== formData.password ? ERROR_MESSAGES.confirmPassword : '';
      default:
        return '';
    }
  };
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  } rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#f26e24] focus:border-[#f26e24] sm:text-sm`}
