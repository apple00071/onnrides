            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-12 pl-8 pr-4 rounded-xl border border-gray-100 bg-gray-50 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-orange-500/20 transition-all text-orange-700"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full h-12 px-3 rounded-xl border border-gray-100 bg-gray-50 text-xs font-bold focus:outline-none focus:ring-2 focus:ring-orange-500/20 transition-all cursor-pointer"
                >
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full h-12 px-4 rounded-xl border border-gray-100 bg-gray-50 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-orange-500/20 transition-all"
                  />
                </div>
              </div>
            )}
